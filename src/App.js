                        ...
                        <div style =  {{background : '#5b5b5b', paddingBottom : '30px', marginBottom : '-20px' }}>
                            <div className={classes.countries}>
                                ...
                                <div className={classes.countriesFlag} style={{textAlign: "center"}}>
                                    <div><a href="/assets/doc/PFRANCE.pdf" target="_blank"><img title={"France"} className={classes.drapeau}  src={require("./assets/fr.png")} alt=""/></a></div>
                            ...
                            <div className={classes.countries}>
                                ...
                                <div className={classes.countriesFlag} style={{textAlign: "center"}}>
                                    <div><a href="/assets/doc/PALLEMAGNE.pdf" target="_blank"><img title={"Allemagne"} className={classes.drapeau}  src={require("./assets/allemagne.png")} alt=""/></a></div>
