...
class App extends Component {
    ...
    And so dear parent, CDAD Compass devoted to your course is poised to knowing what your child is made up with and providing solutions that will help you in terms of :
                    ...
                    <div>
                        ...
                        />
                        <button className={classes.btnTrade} className="close-image" onClick={()=>this.changeLangue(LOCALES.ENGLISH)}><img width={25} src={require("./assets/state_dr.png")}/></button>
                        <button className={classes.btnTrade} className="close-image" onClick={()=>this.changeLangue(LOCALES.FRENCH)}><img width={25} src={require("./assets/france_dr.png")}/></button>
